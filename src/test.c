...
int main(int argc, char *argv[]) {
    ...
    if (!g_ctx.servername) {
        // Print app parameters. This is basically from rdma_bw app. Most of
        // them are not used atm
        printf(
    ...
    //     (start.tv_sec * 1000000 + start.tv_usec ); double avg_latency = (1.0
    //     * duration) / NB_ITERATIONS;
